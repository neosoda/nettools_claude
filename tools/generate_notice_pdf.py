#!/usr/bin/env python3
"""
NetworkTools — Générateur de notice PDF
...
<title>NetworkTools — Notice d'utilisation</title>
<style>
...
@media print {{
  @page {{
    ...
    @top-center {{
      content: "NetworkTools — Notice d'utilisation";
    ...
    @bottom-left {{
      content: "Région Grand Est · Administration réseau";
      font-family: 'Inter', sans-serif;
      font-size: 7pt;
      color: #94a3b8;
    }}
...
<div class="cover">
  ...
  <div class="cover-title">NetworkTools</div>
  ...
  <div class="cover-meta">
    <span>Région Grand Est — Administration réseau</span>
...
def post_process_html(html: str) -> str:
    ...
    # Remove the H1 "NetworkTools — Notice d'utilisation" (it's on the cover)
    html = re.sub(
        r'<h1[^>]*>NetworkTools\s*—\s*Notice[^<]*</h1>',
